export default function handler(req, res) {
  ...
  // Bloquea si intentan abrirlo desde Google Chrome u otro navegador normal
  const isBrowser = /Mozilla|AppleWebKit|Chrome|Safari|Edge|Trident/i.test(userAgent);
  ...
  if (isBrowser) {
    ...
    return res.status(403).send(`
      <html>
        ...
        <body style="background:#0b0b0f; color:white; text-align:center; padding-top:50px; font-family:sans-serif;">
          <h1>Acceso Restringido</h1>
          <p>Este enlace solo puede ser utilizado dentro de ejecutores compatibles.</p>
        </body>
      </html>
    `);
  }

  // Si entra un exploit, entrega el script protegido
...
Window:EditOpenButton({
    ...
    Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(110, 0, 55)),
        ColorSequenceKeypoint.new(0.4, Color3.fromRGB(255, 0, 68)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 0, 68))
    }),
    OnlyMobile = true,
    Enabled = true,
    Draggable = true,
...
local onlineTag = Window:Tag({
    Title = "Onlines Script: 1",
    Icon = "users",
    Color = Color3.fromRGB(0, 255, 128)
})

-- Actualizar visualmente el Tag del contador global cada 3 segundos
task.spawn(function()
    while task.wait(3) do
        pcall(function()
            onlineTag:SetTitle("Onlines Script: " .. tostring(globalOnlineCount))
        end)
    end
end)
...
WindUI:AddTheme({
    ...
    Accent = WindUI:Gradient({
        ["0"] = { Color = Color3.fromRGB(110, 0, 55), Transparency = 0 },
        ["100"] = { Color = Color3.fromRGB(255, 0, 68), Transparency = 0 },
    }, { Rotation = 45 }),
    Background = Color3.fromRGB(5, 2, 4),
    BackgroundTransparency = 0,
    Outline = Color3.fromHex("#ff0044"),
    Text = Color3.fromRGB(255, 255, 255),
    Placeholder = Color3.fromRGB(255, 255, 255),
    Button = Color3.fromRGB(255, 0, 68),
    Icon = Color3.fromHex("#ff0044"),
    Hover = Color3.fromRGB(255, 255, 255),
    WindowBackground = WindUI:Gradient({
        ["0"]   = { Color = Color3.fromRGB(8, 2, 5), Transparency = 0.35 },
        ["100"] = { Color = Color3.fromRGB(8, 2, 5), Transparency = 0.35 },
    }, { Rotation = 45 }),
    WindowShadow = Color3.fromHex("#000000"),
    DialogBackground = Color3.fromHex("#14050a"),
    DialogBackgroundTransparency = 0,
    DialogTitle = Color3.fromRGB(255, 255, 255),
    DialogContent = Color3.fromRGB(255, 255, 255),
    DialogIcon = Color3.fromHex("#ff0044"),
...
InfoTab:Button({
    ...
    Callback = function()
        pcall(function() setclipboard("https://discord.gg/tuenlace") end)
    end
})
...
local crosshairColor = Color3.fromRGB(255, 0, 68)
            ...
            if isEnemy(plr) and plr.Character and plr.Character:FindFirstChild("HumanoidRootPart") then
                ...
                if humanoid and humanoid.Health > 0 then
                    ...
                    if visibleState then
                        ...
                        hrp.Color = Color3.fromRGB(255, 0, 68)
...
local enemyOutlineColor = Color3.fromRGB(255, 0, 68)
local allyOutlineColor = Color3.fromRGB(0, 255, 255)
...
local function applyShaders()
    ...
    Lighting.OutdoorAmbient = Color3.fromRGB(45, 35, 70)
    ...
    Atmosphere.Color = Color3.fromRGB(140, 100, 255)
    Atmosphere.Decay = Color3.fromRGB(55, 10, 90)
